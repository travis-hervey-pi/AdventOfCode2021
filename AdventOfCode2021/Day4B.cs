...
namespace AdventOfCode2021
{
    internal class Day4B : IPuzzle
    {
        ...
        public string GetSolution()
        {
            ...
            {
                var matchingBoards = boards.Where(x => x.ContainsKey(val)).ToList();
                foreach(var b in matchingBoards)
                {
                    b[val].Called = true;
                }
