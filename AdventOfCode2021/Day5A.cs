...
namespace AdventOfCode2021
{
    internal class Day5A : IPuzzle
    {
        ...
        {
            var lines = GetLines();
            var straightLines = lines.Where(line => line.Origin.X == line.Terminus.X || line.Origin.Y == line.Terminus.Y);

            var maxX = Math.Max(straightLines.Max(line => line.Origin.X), straightLines.Max(line => line.Terminus.X));
            var maxY = Math.Max(straightLines.Max(line => line.Origin.Y), straightLines.Max(line => line.Terminus.Y));
    ...
    internal static class Day5Constants
    {
